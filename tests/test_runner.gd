...
const TEST_FILES: Array[String] = [
	...
	"res://tests/unit/domain/exit_base_rule_test.gd",
	"res://tests/unit/domain/extra_roll_on_six_test.gd",
	"res://tests/unit/domain/three_attempts_from_base_test.gd",
	"res://tests/unit/domain/valid_pawns_after_roll_test.gd",
	...
	"res://tests/unit/domain/pawn_capture_test.gd",
	"res://tests/unit/domain/capture_rules_test.gd",
	"res://tests/unit/domain/home_stretch_protection_test.gd",
	"res://tests/unit/domain/home_stretch_test.gd",
	"res://tests/unit/domain/exact_home_stretch_dice_test.gd",
	"res://tests/unit/domain/exact_finish_dice_test.gd",
	"res://tests/unit/domain/pawn_finish_test.gd",
	"res://tests/unit/domain/player_completion_test.gd",
	...
	"res://tests/unit/domain/game_engine_legal_actions_test.gd",
	"res://tests/unit/domain/start_match_handling_test.gd",
	"res://tests/unit/domain/awaiting_roll_phase_test.gd",
	"res://tests/unit/domain/roll_dice_seeded_rng_test.gd",
	"res://tests/unit/domain/awaiting_move_phase_test.gd",
	"res://tests/unit/domain/resolving_move_phase_test.gd",
	"res://tests/unit/domain/turn_end_phase_test.gd",
	"res://tests/unit/domain/match_finished_phase_test.gd",
	...
	"res://tests/unit/domain/command_error_test.gd",
	"res://tests/unit/domain/command_result_test.gd",

extends TestCase
## Business-critical тестове за движение по общото трасе (Task #96 /
## docs/V1_GAME_DESIGN.md §3; CURRENT_YELLOW_BEHAVIOR YEL-040–043;
## docs/V1_ARCHITECTURE.md §4.3 / §12; GAP-008 rejected).
##
## Инварианти: точен брой клетки по player route; дестинация на MAIN_PATH
## остава MAIN_PATH; без clamp при overshoot; MovePawnCommand ↔ PawnMoved.

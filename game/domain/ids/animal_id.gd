...
##
## v1 обем: 5 животни; 2 налични от старта (STARTER), останалите през кампанията.
...
## Всички v1 animal_id.
const ALL: Array[StringName] = [PIG, RABBIT, DOG, COW, HEN]
...
static func is_valid(id: StringName) -> bool:
	return id == PIG or id == RABBIT or id == DOG or id == COW or id == HEN

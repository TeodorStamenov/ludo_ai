...
|---|---|
| `model/`     | `GameState`, `PlayerState`, `PawnState`, `TurnState`, `GiftState`, `MatchResult`, `CommandResult`, `CommandError`, `MatchConfig`, `MatchConfigValidator`, `BoardDefinition`, `BoardDefinitionValidator`, `GameStateInvariantChecker`, `CellOccupancy` — стабилни data структури и валидация |
